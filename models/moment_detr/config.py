...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["qvhighlights", "charades", "tacos"])
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            opt.results_dir = os.path.join(opt.results_root, "moment_detr", "-".join([opt.dset_name, opt.exp_id, time.strftime("%Y_%m_%d_%H")]))
