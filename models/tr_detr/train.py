...
from models.tr_detr.config import BaseOptions
from models.tr_detr.start_end_dataset import \
...
from models.tr_detr.inference import eval_epoch, start_inference, setup_model
from utils.basic_utils import AverageMeter, dict_to_markdown
from utils.model_utils import count_parameters

from models.tr_detr.loss_fun.VTCLoss import VTCLoss
from models.tr_detr.loss_fun.CTCLoss import CTC_Loss
import logging
...
def train(model, criterion, optimizer, lr_scheduler, train_dataset, val_dataset, opt):
    ...
    for epoch_i in trange(start_epoch, opt.n_epoch, desc="Epoch"):
        ...
        if opt.eval_path is not None and (epoch_i + 1) % eval_epoch_interval == 0:
            ...
            stop_score = metrics["brief"]["MR-full-mAP-key"]
