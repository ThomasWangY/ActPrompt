...
######## data paths
results_root=/mnt/data2/tvg/UniVTG/results
data_root=/mnt/data2/tvg/UniVTG/data
train_path=${data_root}/${dset_name}/metadata/train.jsonl
eval_path=${data_root}/${dset_name}/metadata/test.jsonl
